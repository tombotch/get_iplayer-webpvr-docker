...
RUN ["wget", "https://raw.githubusercontent.com/get-iplayer/get_iplayer/v3.31/get_iplayer"]
...
RUN ["wget", "https://raw.githubusercontent.com/get-iplayer/get_iplayer/v3.31/get_iplayer.cgi"]
