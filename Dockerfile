...
RUN wget https://raw.githubusercontent.com/get-iplayer/get_iplayer/v$VERSION/get_iplayer
...
RUN wget https://raw.githubusercontent.com/get-iplayer/get_iplayer/v$VERSION/get_iplayer.cgi
