...
RUN ["wget", "https://raw.githubusercontent.com/get-iplayer/get_iplayer/v3.27/get_iplayer"]
...
RUN ["wget", "https://raw.githubusercontent.com/get-iplayer/get_iplayer/v3.27/get_iplayer.cgi"]
